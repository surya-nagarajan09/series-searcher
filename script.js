...
async function search(){
   ...
   outerdiv.innerHTML="";
    ...
    let request=await fetch("http://api.tvmaze.com/search/shows?q="+query);
    ...
    network.innerHTML="Network:"+response[i].show.network.country.code
    

    innerdiv.append(banner,title_of_series,genres,lang,type,run_time,network)
    ...
    window.alert("result not found//try another")
}
search()
